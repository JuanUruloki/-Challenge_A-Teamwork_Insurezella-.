      ...
      <div className="relative flex flex-col items-center w-full">
        ...
        <div className="flex flex-row items-center w-[90vw] shadow-cards p-8 bg-white relative z-10 -mb-12">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="text-gray-600 space-y-2">
              <li className="flex items-center text-lg font-textRegular text-slate-400">About Us</li>
              <li className="flex items-center text-lg font-textRegular text-slate-400">Careers</li>
              <li className="flex items-center text-lg font-textRegular text-slate-400">Industry News</li>
              <li className="flex items-center text-lg font-textRegular text-slate-400">Privacy Policy</li>
              <li className="flex items-center text-lg font-textRegular text-slate-400">Terms & Conditions</li>
            </ul>
          </div>

          {/* Contacto */}
          <div className="w-full md:w-1/4">
            <h3 className="font-texts text-3xl text-darkBlue mb-4">Get In Touch</h3>
            <ul className="text-gray-600 space-y-2">
              <li className="flex items-center text-lg font-textRegular text-slate-400">
