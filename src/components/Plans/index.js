...
const Plans = () => {
  return (
    <div className="flex flex-col w-full min-h-screen">
      <div className="flex flex-row w-auto h-[600px] m-20">
        <div
        ...
        <div className="flex flex-col items-start justify-evenly h-full w-1/2 px-16">
          <h2 className="text-6xl font-heroTitle">
      ...
      <div className="flex flex-col w-full items-center justify-center py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-32 w-full px-4 md:px-12 lg:px-64 bg-white">
